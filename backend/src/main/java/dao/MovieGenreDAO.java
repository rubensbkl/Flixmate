...
public class MovieGenreDAO extends DAO {
     ...
     * @return Uma lista de objetos MovieGenre representando os filmes associados ao
     *         gênero
     */
    ...
    // st.close();
    // } catch (SQLException e) {
    // System.err.println("Erro ao buscar filmes por ID de gênero: " +
    // e.getMessage());
    // }
    // return movies;
    // }
     ...
     * 
     * @param movieId O ID do filme
     * @return Uma lista de objetos MovieGenre representando os gêneros associados
     *         ao filme
     */
    ...
    // st.close();
    // } catch (SQLException e) {
    // System.err.println("Erro ao buscar gêneros por ID de filme: " +
    // e.getMessage());
    // }
    // return movieGenres;
    // }
